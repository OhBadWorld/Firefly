---
title: "算法day07:滑动窗口技巧"
published: 2022-03-13 17:36:34
tags: [算法, javascript]
category: 前端算法
---
...
下面就直接上**四道** LeetCode 原题来套这个框架，其中第一道题会详细说明其原理，后面四道就直接闭眼睛秒杀了。
...
![76. 最小覆盖子串](../imgs/algorithms/07/algorithms01.png)
...
![](../imgs/algorithms/07/algorithms02.jpg)

增加 `right`，直到窗口 `[left, right]` 包含了 `T` 中所有字符：

![](../imgs/algorithms/07/algorithms03.jpg)

现在开始增加 `left`，缩小窗口 `[left, right]`。

![](../imgs/algorithms/07/algorithms04.jpg)

直到窗口中的字符串不再符合要求，`left` 不再继续移动。

![](../imgs/algorithms/07/algorithms05.jpg)
...
![567. 字符串排列](../imgs/algorithms/07/algorithms06.png)
...
![3. 最长无重复子串](../imgs/algorithms/07/algorithms07.png)
...
好了，本文就讲到这里，相信你已经掌握了滑动窗口算法的核心逻辑。
